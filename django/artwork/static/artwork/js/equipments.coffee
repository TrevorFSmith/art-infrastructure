    ...
    render: ->
      ...
      dom.div {className: "ui card"},
        ...
        dom.div {className: "content"},
          ...
          dom.div null, "Device type:  #{if @props.equipment.device_info.type then @props.equipment.device_info.type else "None"}"
          dom.div null, "Device name:  #{if @props.equipment.device_info.name then @props.equipment.device_info.name else "None"}"
          dom.div null, "Photos:"
