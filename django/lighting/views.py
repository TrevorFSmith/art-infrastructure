...
def crestons(request):
    return render(request, 'lighting/crestons.html', {})
...
def bacnet_lights(request):
    return render_to_response('lighting/bacnet_lights.html', {})
...
def projectors(request):
    return render_to_response('lighting/projectors.html', {})
